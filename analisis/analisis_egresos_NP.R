...
procesar_egresos <- function(data, establecimiento,prestacion){
  data.frame(data) |>
    ...
    filter(estab_dest == establecimiento, tipo_prest == prestacion, !grepl("^09", presta_min)) |> #tipo_prest =1:CNE =4:Qx
    select(-comuna) |>
